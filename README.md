...
| `showMini`                | *Optional* - if true, displays the miniPlayer configurations as defined in miniplayercontrols. <br><br> **Possible values:** true/false.<br> **Default value:** false
...
| `defaultplayercontrols`      | *Optional* - a list of buttons to display in the control area of the player when the default player is displayed.<br><br> **Possible values:** Any of the controls shown in the default values:<br> **Default value:** ['Back', 'Play', 'Stop', 'Next', 'Volume', 'Shuffle', 'Repeat', 'MiniPlayer', 'DLNA', 'MiniPlayer']
